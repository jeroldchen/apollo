...
class RCNNProposalPlugin : public nvinfer1::IPlugin {
 public:
  RCNNProposalPlugin(const BBoxRegParameter &bbox_reg_param,
    ...
    NMSSSDParameter nms_param =
        detection_output_ssd_param.nms_param();
  ...
  nvinfer1::Dims getOutputDimensions(int index,
    ...
    // TODO(chenjiahao): complete dims assertion
//    return nvinfer1::Dims2(acc_box_num_, out_channel_);
 ...
 private:
  ...
  // TODO(chenjiahao): implement not regressing agnostic boxes
