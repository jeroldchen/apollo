...
class RPNProposalSSDPlugin : public nvinfer1::IPlugin {
 public:
  RPNProposalSSDPlugin(const BBoxRegParameter &bbox_reg_param,
...
//    output_dims.d[0] = out_rois_num_;
//    output_dims.d[0] = top_n_ * 4;
//    output_dims.d[1] = 5;
//    return nvinfer1::Dims4(out_rois_num_, 5, 1, 1);
